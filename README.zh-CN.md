...
[docs/dev-history/prompts](docs/dev-history/prompts) 中的 Markdown 文件，是开发和发布准备过程中给出的历史提示词。它们只是项目历史，不是正常安装或使用所需文件。

提示词顺序如下：

1. [初始 AI News Monitor 提示词](docs/dev-history/prompts/01-codex_prompt_ai_news_monitor.md)
2. [下一阶段产品提示词](docs/dev-history/prompts/02-codex_next_phase_prompt.md)
3. [更新提示词](docs/dev-history/prompts/03-codex_update_prompt.md)
4. [下一轮迭代提示词](docs/dev-history/prompts/04-ai_news_monitor_next_iteration_prompt.md)
5. [最终目标候选提示词](docs/dev-history/prompts/05-ai_news_monitor_final_target_candidate_prompt.md)
6. [GitHub 前界面稳定提示词](docs/dev-history/prompts/06-ai_news_monitor_pre_github_interface_stabilization_prompt.md)
7. [来源可靠性和新鲜度提示词](docs/dev-history/prompts/07-ai_news_monitor_source_reliability_freshness_prompt.md)
8. [GitHub 上传就绪提示词](docs/dev-history/prompts/08-ai_news_monitor_github_upload_readiness_prompt.md)
9. [E2E 运行闭环提示词](docs/dev-history/prompts/09-ai_news_monitor_e2e_operational_closure_prompt.md)
10. [最终 GitHub 上传清理提示词](docs/dev-history/prompts/10-ai_news_monitor_final_github_upload_cleanup_prompt.md)
11. [阶段验证提示词](docs/dev-history/prompts/11-phase_verification_prompt.md)
...
默认使用 Fast Alert，内容包括原文标题、链接、翻译标题、来源、发布时间、短摘要、匹配原因、关键词/实体、来源可靠性、多来源聚合上下文和质量排序解释。
