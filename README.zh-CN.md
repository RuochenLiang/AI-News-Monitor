...
[docs/dev-history/prompt.md](docs/dev-history/prompt.md) 这个 Markdown 文件，集中整理了开发和发布准备过程中给出的历史提示词。它只是项目历史，不是正常安装或使用所需文件。

提示词顺序如下：

1. [初始 AI News Monitor 提示词](docs/dev-history/prompt.md#01-initial-ai-news-monitor-prompt)
2. [下一阶段产品提示词](docs/dev-history/prompt.md#02-next-phase-product-prompt)
3. [更新提示词](docs/dev-history/prompt.md#03-update-prompt)
4. [下一轮迭代提示词](docs/dev-history/prompt.md#04-next-iteration-prompt)
5. [最终目标候选提示词](docs/dev-history/prompt.md#05-final-target-candidate-prompt)
6. [GitHub 前界面稳定提示词](docs/dev-history/prompt.md#06-pre-github-interface-stabilization-prompt)
7. [来源可靠性和新鲜度提示词](docs/dev-history/prompt.md#07-source-reliability-and-freshness-prompt)
8. [GitHub 上传就绪提示词](docs/dev-history/prompt.md#08-github-upload-readiness-prompt)
9. [E2E 运行闭环提示词](docs/dev-history/prompt.md#09-e2e-operational-closure-prompt)
10. [最终 GitHub 上传清理提示词](docs/dev-history/prompt.md#10-final-github-upload-cleanup-prompt)
11. [阶段验证提示词](docs/dev-history/prompt.md#11-phase-verification-prompt)
